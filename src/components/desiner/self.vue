<template>
    <div id="self-wrap" class="slef-wrap">
        <video-player   class="video-player-box vjs-big-play-centered hide" ref="videoPlayer" :options="{preload:'auto',controls: false,x5-video-player-type:"h5" x5-video-player-fullscreen:false, webkit-playsinline:false playsinline :true,muted: true,height:''+ht+'',sources: [{type: 'video/mp4',src:'' +selfMes.self_introduction_video_url+''}]}" >
